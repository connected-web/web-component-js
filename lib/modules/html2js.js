...
module.exports = function (html, fileName) {
  ...
  $('script').each(function (index, value) {
    var src = value.attribs.src;
    var id = value.attribs.id;
    if (src) {
      console.log('Extrnal script item:', {
        id: id,
        src: src
      });
    } else {
      console.log('Block script:', value.attribs);
    }
  });
  ...
  */
  ...
  js = autoloaderTemplate
    ...
    .replace('{{requiredScripts}}', requiredScripts)
